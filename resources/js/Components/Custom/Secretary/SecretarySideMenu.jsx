...
export default function SecretarySideMenu() {
    return (
        <>
            {/* Navigation */}
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                <li className="items-center">
                    <NavLink
                        ...
                        className={"text-xs uppercase py-3 font-bold block "}
                        to="/dashboard/secretary/patients"
                    >
                ...
                <li className="items-center">
                    <NavLink
                        ...
                        className="text-xs uppercase py-3 font-bold block"
                        to="/dashboard/secretary/patients/create"
                    >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                <li className="items-center">
                    <NavLink
                        ...
                        className="text-xs uppercase py-3 font-bold block"
                        to="/dashboard/secretary/personnels"
                    >
                ...
                <li className="items-center">
                    <NavLink
                        ...
                        className="text-xs uppercase py-3 font-bold block"
                        to="/dashboard/secretary/personnels/create"
                    >
